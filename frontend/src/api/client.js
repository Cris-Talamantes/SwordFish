...
/**
 * Leave unset for same-origin `/api` (Vite dev proxies to Flask; Vercel rewrites `/api` to the Python function).
 * Set VITE_API_URL only if the API is on another origin (e.g. separate backend host).
 */
